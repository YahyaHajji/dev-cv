...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/yahya-hajji-b2660a288/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@youness_",
    icon: Instagram,
    url: "https://www.instagram.com/upfstudentlife",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@Youness",
    icon: Github,
    url: "https://github.com/YahyaHajji",
    color: "#ffffff",
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      <h3 className="text-xl font-semibold text-white mb-6 flex items-center gap-2">
        <span className="inline-block w-8 h-1 bg-[#009E66] rounded-full"></span>
        Connect With Me
      </h3>
